...
def ann_income_degree_bar(df):
    """
    Produces a bar chart comparing annual income and degree obtained, grouped by gender.
    """
...
def base_pay_education_level(gp):
    """
    Produces a bar chart comparing base pay and education level attained, grouped by gender.
    """
